...
;; Assign males to be happy or unhappy  
...
to females-reproduce
  ;; hatch infant in same location
  ;; infants sex is assigned randomly
  ;; age is set to 0
  ;; they start with half of the energy level as their mother (they need more energy/care to survive).
  ;; subtract infant's initial energy to the energy levels of mon (female-energy)
end
...
180
NIL
count patches with [number-females > 1]
17
1
11
